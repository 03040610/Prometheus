...
ActiveRecord::Schema.define(version: 2023_03_31_035803) do
  ...
  create_table "rooms", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["teachers_id"], name: "index_rooms_on_teachers_id"
  end
  ...
  add_foreign_key "rooms", "teachers", column: "teachers_id"
end
